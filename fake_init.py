...
print(f"DROP DATABASE IF EXISTS {env_value_or_error(env.MAIN_DATABASE)}")
print(f"DROP DATABASE IF EXISTS {env_value_or_error(env.TEMP_DATABASE)}")

print(f"CREATE DATABASE {env_value_or_error(env.MAIN_DATABASE)}")
print(f"CREATE DATABASE {env_value_or_error(env.TEMP_DATABASE)}")
